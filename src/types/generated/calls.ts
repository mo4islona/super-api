...
export class BalancesForceTransferCall {
   ...
   *  # </weight>
   */
  get asV21(): {source: v21.GenericMultiAddress, dest: v21.GenericMultiAddress, value: bigint} {
    assert(this.isV21)
  ...
  get asLatest(): {source: v2800.MultiAddress, dest: v2800.MultiAddress, value: bigint} {
    deprecateLatest()
    return this.asV2800
  }
}
...
export class BalancesTransferCall {
   ...
   *  # </weight>
   */
  get asV21(): {dest: v21.GenericMultiAddress, value: bigint} {
    assert(this.isV21)
    return this.ctx._chain.decodeCall(this.ctx.extrinsic)
  }
  ...
  get asLatest(): {dest: v2800.MultiAddress, value: bigint} {
    deprecateLatest()
    return this.asV2800
  }
}
...
export class BalancesTransferAllCall {
   ...
   *    #</weight>
   */
  get asV21(): {dest: v21.GenericMultiAddress, keepAlive: boolean} {
    assert(this.isV21)
    return this.ctx._chain.decodeCall(this.ctx.extrinsic)
  }
  ...
  get asLatest(): {dest: v2800.MultiAddress, keepAlive: boolean} {
    deprecateLatest()
    return this.asV2800
  }
}
