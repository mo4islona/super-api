...
export class BalancesForceTransferCall {
  ...
  get asLatest(): {source: v1.GenericMultiAddress, dest: v1.GenericMultiAddress, value: bigint} {
    deprecateLatest()
    return this.asV1
  }
}
...
export class BalancesTransferCall {
  ...
  get asLatest(): {dest: v1.GenericMultiAddress, value: bigint} {
    deprecateLatest()
    return this.asV1
  }
}
...
export class BalancesTransferAllCall {
   ...
   *    #</weight>
   */
  get asV801(): {dest: v801.GenericMultiAddress, keepAlive: boolean} {
    assert(this.isV801)
    return this.ctx._chain.decodeCall(this.ctx.extrinsic)
  }
  ...
  get asLatest(): {dest: v801.GenericMultiAddress, keepAlive: boolean} {
    deprecateLatest()
    return this.asV801
  }
}
