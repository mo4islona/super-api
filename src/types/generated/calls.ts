...
export class BalancesForceTransferCall {
   ...
   *  # </weight>
   */
  get asV160(): {source: v160.GenericMultiAddress, dest: v160.GenericMultiAddress, value: bigint} {
    assert(this.isV160)
  ...
  get asLatest(): {source: v171.MultiAddress, dest: v171.MultiAddress, value: bigint} {
    deprecateLatest()
    return this.asV171
  }
}
...
export class BalancesTransferCall {
   ...
   *  # </weight>
   */
  get asV160(): {dest: v160.GenericMultiAddress, value: bigint} {
    assert(this.isV160)
    return this.ctx._chain.decodeCall(this.ctx.extrinsic)
  }
  ...
  get asLatest(): {dest: v171.MultiAddress, value: bigint} {
    deprecateLatest()
    return this.asV171
  }
}
...
export class BalancesTransferAllCall {
   ...
   *    #</weight>
   */
  get asV160(): {dest: v160.GenericMultiAddress, keepAlive: boolean} {
    assert(this.isV160)
    return this.ctx._chain.decodeCall(this.ctx.extrinsic)
  }
  ...
  get asLatest(): {dest: v171.MultiAddress, keepAlive: boolean} {
    deprecateLatest()
    return this.asV171
  }
}
